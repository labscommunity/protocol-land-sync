...
var PATH = '.';
var FILENAME = 'repo.zip';
function loadIgnoreList() {
    var gitignorePath = path.join(PATH, '.gitignore');
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, zipRepo().catch(function (error) {
                    process.exit(1);
                })];
            case 1:
                zipBuffer = _a.sent();
                fs.writeFile(FILENAME, zipBuffer, function (error) {
                    if (error) {
